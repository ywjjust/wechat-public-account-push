export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx637480ba00d37c6f",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "a853707fd89285e1a8c923b9789b67ef",
  ...
  USERS: [
    {
      ...
      id: "oZ3Ng5x-BwPa49j6ugVOkCTsxEH0",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "	D7mwF1ZBAEIdWSZcIR2VWoDMjdHRBnGdfQcWjy6nfC8",
      // 所在省份
      province: "重庆市",
      // 所在城市
      city: "高新区",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "宝贝吱吱", "year": "1996", "date": "09-09"},
